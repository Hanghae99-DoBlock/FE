...
export const __signUp = createAsyncThunk(
    ...
    async (payload,thunkAPI) =>{
        try{
            const {data} = await axios.post(`${serverUrl}/api/members/signup`,payload)
...
export const __checkEmail = createAsyncThunk(
    ...
    async(payload,thunkAPI)=>{
        try{
            const data = await axios.post(`${serverUrl}/api/members/checkmail`,payload)
            console.log(data)
            return thunkAPI.fulfillWithValue(data)
        }catch(e){
            return thunkAPI.rejectWithValue(e.code)
...
export const __checkNick = createAsyncThunk(
    ...
    async(payload,thunkAPI)=>{
        try{
            ...
            const data = await axios.post(`${serverUrl}/api/members/checkname`,payload)
            console.log(data)
            return thunkAPI.fulfillWithValue(data)
        }catch(e){
            return thunkAPI.rejectWithValue(e.code)
